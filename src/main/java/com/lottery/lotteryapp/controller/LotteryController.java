...
public class LotteryController {
    ...
    public LotteryResponse initiateLottery(@RequestParam("lotteryName") String lotteryName){
    ...
    public LotteryResultResponse lotteryResults(@PathVariable("lotteryId") Long lotteryId){
